...
Документация в репозитории приведена к единому виду и нормальной кодировке. Если дальше будем доводить проект до полной сдачи, следующим шагом разумно синхронизировать текст ТЗ с фактической реализацией и поправить спорные места в коде.
